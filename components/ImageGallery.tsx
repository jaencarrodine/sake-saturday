        ...
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute top-2 left-2">
              <Badge variant={getTypeBadgeVariant(image.type)}>
                {image.isAiGenerated && "✨ "}
        ...
        <DialogContent className="max-w-[90vw] max-h-[90vh] p-0">
          {selectedIndex !== null && (
            <div className="relative">
              <div className="flex items-center justify-center min-h-[400px] max-h-[80vh] bg-black/90">
                <img
              ...
              <div className="absolute top-4 right-4 flex gap-2">
                <Badge variant={getTypeBadgeVariant(images[selectedIndex].type)}>
